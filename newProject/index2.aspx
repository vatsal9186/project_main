		...
		<div class="single-product-item">
			<div class="product-image">
				<%--<a href="singleproduct.aspx"><img src="assets/img/products/product-img-1.jpg" alt=""></a>--%>
				 <a href="#"><asp:Image ImageUrl="assets/img/products/papaya.jpg" runat="server" style="height:200px"/></a>
			</div><br />
			<asp:Label ID="Label1" runat="server" Text=Papaya></asp:Label><br />
			<%--<h3>Strawberry</h3>--%>
			<%--<p class="product-price"><span>Per Kg</span> 85₹ </p>--%>
			 <asp:Label ID="Label2" runat="server">85</asp:Label>kg<br />
		...
		<div class="single-product-item">
			<div class="product-image">
				<%--<a href="singleproduct.aspx"><img src="assets/img/products/product-img-2.jpg" alt=""></a>--%>
				 <a href="#"><asp:Image ImageUrl="assets/img/products/cherry.jpg" runat="server" style="height:200px"/></a>
			</div><br />
			<asp:Label ID="Label4" runat="server" Text=Cherry></asp:Label><br />
			<%--<h3>Berry</h3>--%>
			<%--<p class="product-price"><span>Per Kg</span> 70₹ </p>--%>
			 <asp:Label ID="Label5" runat="server">70</asp:Label>/kg<br />
		...
		<div class="single-product-item">
			<div class="product-image">
				<%--<a href="singleproduct.aspx"><img src="assets/img/products/product-img-3.jpg" alt=""></a>--%>
				 <a href="#"><asp:Image ImageUrl="assets/img/products/lychee.jpg" runat="server" style="height:200px"/></a>
			</div><br />
			<asp:Label ID="Label7" runat="server" Text=Lychee></asp:Label><br />
			<%--<h3>Lemon</h3>--%>
			<%--<p class="product-price"><span>Per Kg</span> 35₹ </p>--%>
			 <asp:Label ID="Label8" runat="server">35</asp:Label>/kg<br />
...
<div class="row clearfix">
	...
	<div class="content-column col-lg-6">
		...
		<div class="text"> Explore a diverse selection of fresh, locally sourced fruits and vegetables, all delivered straight to your door. Our commitment to quality and sustainability ensures that you enjoy the best produce while supporting responsible farming practices.</div>
		<!--Countdown Timer-->
