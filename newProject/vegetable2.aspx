    ...
    <div class="col-lg-4 col-md-6 text-center strawberry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/cabbage.jpg" runat="server"  style="height:390px"/></a>
            </div>
            ...
            <%--<p class="product-price"><span>Per Kg</span> 85₹ </p>--%>
			 <asp:Label ID="Label10" runat="server">85</asp:Label>/kg<br />
    ...
    <div class="col-lg-4 col-md-6 text-center berry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/peas.jpg" runat="server" style="height:390px" /></a>
            </div>
            <%--<h3>Peas</h3>--%>
			<asp:Label ID="Label2" runat="server" Text=Peas></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 70₹ </p>--%>
			 <asp:Label ID="Label12" runat="server">70</asp:Label>/kg<br />
    ...
    <div class="col-lg-4 col-md-6 text-center lemon">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/ladyfinger.jpg" runat="server" style="height:390px" /></a>
            </div>
            <%--<h3>LadyFinger</h3>--%>
			<asp:Label ID="Label3" runat="server" Text=LadyFinger></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 35₹ </p>--%>
			 <asp:Label ID="Label14" runat="server">35</asp:Label>/kg<br />
    ...
    <div class="col-lg-4 col-md-6 text-center">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/beans.jpg" runat="server"  style="height:390px"/></a>
            </div>
            <%--<h3>Beans</h3>--%>
    ...
    <div class="col-lg-4 col-md-6 text-center">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/springonion.jpg" runat="server" style="height:390px" /></a>
            </div>
            <%--<h3>SpringOnion</h3>--%>
    ...
    <div class="col-lg-4 col-md-6 text-center strawberry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/capsicum.jpg" runat="server"  style="height:390px"/></a>
            </div>
            <%--<h3>Capsicum</h3>--%>
    ...
    <div class="col-lg-4 col-md-6 text-center strawberry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/mushrooms.jpg" runat="server" style="height:390px" /></a>
            </div>
            <%--<h3>Mushrooms</h3>--%>
    ...
    <div class="col-lg-4 col-md-6 text-center berry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/spinach.jpg" runat="server" style="height:390px"/></a>
            </div>
            <%--<h3>Spinach</h3>--%>
    ...
    <div class="col-lg-4 col-md-6 text-center lemon">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/corn.jpg" runat="server"  style="height:390px"/></a>
            </div>
            <%--<h3>Corn</h3>--%>
